...
<div class="from-col-password">
  <p><div class="from-job"></p>
    ...
    <div class="from-txt">
    <input type="text" class="txt" name="lamviec" placeholder="Nhập" list="lamviec">
    <datalist id="lamviec">
 ...
 <p><div class="from-job"></p>
    ...
    <div class="from-txt">
    <input type="text" name="loaihopdong" class="txt"  placeholder="Nhập" list="loaihopdong">
    ...
    <br>
    <div class="from-txt">
      <textarea id="freeform" name="freeform" rows="15" cols="80"> </textarea>
    </div>
    </div>
    <br>
  </div>
...
<div class="from-col-password">
  ...
  <label>Kinh nghiệm yêu cầu </label>
    <div class="from-txt">
    <input type="text" name="kinhnghiem" class="txt" placeholder="Nhập" value="Năm" >
    </div>
    </div>
    <!-- f -->
    <p><div class="from-job"></p>
